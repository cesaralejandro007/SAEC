        ...
        <div class="content-wrapper">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Tipos de Costo Fijo</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="dashboard">Home</a></li>
                        <li class="breadcrumb-item active">Tipo de Costo Fijo</li>
                        </ol>
                    </div>
                    </div>
                </div><!-- /.container-fluid -->
        ...
        <div class="modal fade" id="gestion">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <h4 class="modal-title">Tipo de Costo Fijo</h4>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="" class="form-control" id="id_caracteristica">
                                    ...
                                    <span id="sid_caracteristica"></span>
                                </div>
