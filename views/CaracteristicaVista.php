...
<body class="hold-transition sidebar-mini">
                        ...
                        <div class="container">
                            <div class="card">
                                <div class="card-header">
                                    <button class="btn btn-secondary" id="nuevo"><i class="fas fa-plus"></i> Nueva caracteristica</button>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
        ...
        <div class="modal fade" id="gestion">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <h4 class="modal-title">Caracteristica</h4>
    ...
    <script src=<?php echo VALIDATION.'caracteristica.js';?>></script>
  <script>
  $(function () {
    $("#example1").DataTable({
